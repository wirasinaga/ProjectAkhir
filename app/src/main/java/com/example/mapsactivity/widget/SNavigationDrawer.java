...
public class SNavigationDrawer extends RelativeLayout{
    ...
    //Layouts
    protected List<com.example.mapsactivity.data.MenuItem> menuItemList;
    ...
    public void openDrawer(){
        ...
        containerCV.animate().translationX(rootLayout.getX() +(rootLayout.getWidth() / 8)+ (rootLayout.getWidth() / 2) ).setDuration(500).start();
        final Handler handler = new Handler();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
    ...
    public void addMenuItem(MenuItem menuItem){
        if(menuItemList!=null){
            menuItemList.add((com.example.mapsactivity.data.MenuItem) menuItem);
        }
    }

    //Getting the list of Menu Items
    public List<com.example.mapsactivity.data.MenuItem> getMenuItemList() {
        return menuItemList;
    }

    //Setting the list of Menu Items
    public void setMenuItemList(List<com.example.mapsactivity.data.MenuItem> menuItemList) {
