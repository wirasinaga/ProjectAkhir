...
import com.example.mapsactivity.BuildConfig;
...
public class ServiceGenerator {
    ...
    private static Retrofit.Builder builder =
            new Retrofit.Builder()
                    .baseUrl(DbContract.SERVER_HOST)
    ...
    public static <S> S createService(Class<S> serviceClass, String bearer) {
        ...
        httpClient.addInterceptor(new Interceptor() {
            ...
            public Response intercept(Chain chain) throws IOException {
                ...
                Request.Builder requestBuilder = original.newBuilder()
                        .header("auth-token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE2NTU2MjkyOTR9.bq37UzTAUdWSBv6O-Jvq6F_kKmEC9rJ4WdyEDrf5Ppw")
                        .header("Accept", "*/*")
